...
func (c *ticketRedeemerClient) QueueTicket(ctx context.Context, in *Ticket, opts ...grpc.CallOption) (*QueueTicketRes, error) {
	...
	err := c.cc.Invoke(ctx, TicketRedeemer_QueueTicket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketRedeemerClient) MaxFloat(ctx context.Context, in *MaxFloatReq, opts ...grpc.CallOption) (*MaxFloatUpdate, error) {
	...
	err := c.cc.Invoke(ctx, TicketRedeemer_MaxFloat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketRedeemerClient) MonitorMaxFloat(ctx context.Context, in *MaxFloatReq, opts ...grpc.CallOption) (TicketRedeemer_MonitorMaxFloatClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TicketRedeemer_ServiceDesc.Streams[0], TicketRedeemer_MonitorMaxFloat_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &ticketRedeemerMonitorMaxFloatClient{ClientStream: stream}
...
func _TicketRedeemer_MonitorMaxFloat_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TicketRedeemerServer).MonitorMaxFloat(m, &ticketRedeemerMonitorMaxFloatServer{ServerStream: stream})
}
