...
func parseLivepeerConfig() starter.LivepeerConfig {
	...
	cfg.InitialDiscoveryTimeout = flag.Int("initialDiscoveryTimeout", *cfg.InitialDiscoveryTimeout, "Time in milliseconds to wait for first round of GetOrchestrator responses (default = 500ms)")
	// Transcoding:
