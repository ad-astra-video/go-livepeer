...
func parseLivepeerConfig() starter.LivepeerConfig {
	...
	cfg.SelectStakeWeight = flag.Int("selectStakeWeight", *cfg.SelectStakeWeight, "Stake weight to use in weighted selection on stake, price and performance (whole numbers only)")
	cfg.SelectPriceWeight = flag.Int("selectPriceWeight", *cfg.SelectPriceWeight, "Price weight to use in weighted selection on stake, price and performance (whole numbers only)")
	cfg.SelectPerformanceWeight = flag.Int("selectPerformanceWeight", *cfg.SelectPerformanceWeight, "Performance weight to use in weighted selection on stake, price and performance (whole numbers only)")
	cfg.SelectStakeMinimum = flag.Int64("selectStakeMinimum", *cfg.SelectStakeMinimum, "Minimum stake to include orchestrator in selection (whole numbers only)")
	cfg.SelectStakeMaximum = flag.Int64("selectStakeMaximum", *cfg.SelectStakeMaximum, "Capped amount of stake for orchestrator in selection (whole numbers only)")
	cfg.SelectPriceMinimum = flag.Int64("selectPriceMinimum", *cfg.SelectPriceMinimum, "Minimum price to include orchestrator in selection (whole numbers only)")
	cfg.SelectPriceMaximum = flag.Int64("selectPriceMaximum", *cfg.SelectPriceMaximum, "Maximum price to include orchestrator in selection (whole numbers only)")
	cfg.SelectPerformanceMinimum = flag.Float64("selectPerformanceMinimum", *cfg.SelectPerformanceMinimum, "Minimum performance to include orchestrator in selection (supports up to 3 decimals)")
	cfg.SelectPerformanceMaximum = flag.Float64("selectPerformanceMaximum", *cfg.SelectPerformanceMaximum, "Maximum performance to include orchestrator in selection (supports up to 3 decimals)")
