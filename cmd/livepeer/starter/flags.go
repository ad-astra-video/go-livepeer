...
func NewLivepeerConfig(fs *flag.FlagSet) LivepeerConfig {
	...
	cfg.ReserveMultiplier = fs.Int("reserveMultiplier", *cfg.ReserveMultiplier, "The reserve multiplier used to determine acceptable faceValue for tickets (default = total active orchestrators for round)")
